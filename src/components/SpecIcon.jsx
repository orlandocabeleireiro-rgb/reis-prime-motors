...
// usado nos restantes símbolos do site. Identifica a linha por uma chave
// estável (não pelo rótulo, que varia consoante o idioma).
export default function SpecIcon({ specKey, car }) {
  switch (specKey) {
    case "marca":
