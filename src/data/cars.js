...
export const CARS = [
  ...
  },
  {
    id: 23,
    marca: "BMW",
    modelo: "X6 M60i xDrive",
    imagem: "/cars/bmw-x6-m60i.png",
    ano: 2024,
    km: 6000,
    preco: 97900,
    combustivel: "Gasolina",
    ...
    descricao:
      "BMW X6 M60i xDrive, o topo de gama do SUV-coupé da BMW. Praticamente novo, combina o desempenho de um M com o conforto e o espaço de um SUV premium.",
    destaques: [
      "Motor V8 biturbo de 530 cv",
      "Tração integral xDrive",
      "Travões M Sport com pinças vermelhas",
      "Faróis Laser BMW",
      "Interior em pele Merino",
    ],
  },
  {
    id: 24,
    marca: "BMW",
    modelo: "i4 Gran Coupé eDrive40",
    imagem: "/cars/bmw-i4-gran-coupe.png",
    ano: 2024,
    km: 4000,
    preco: 54900,
    combustivel: "Elétrico",
    transmissao: "Automática",
    cor: "Cinzento Brooklyn",
    portas: 4,
    potencia: 340,
    consumo: "16,0 kWh/100km",
    descricao:
      "BMW i4 Gran Coupé, elétrico com a elegância de um gran coupé BMW. Quilometragem muito reduzida, ainda com o essencial da garantia de fábrica.",
    destaques: [
      "Autonomia até 520 km",
      "BMW Curved Display",
      "Carregamento rápido DC",
      "Assistente de condução BMW",
    ],
  },
  {
    id: 25,
    marca: "Mercedes-Benz",
    modelo: "Classe C 220d AMG Line",
    imagem: "/cars/mercedes-classe-c.png",
    ano: 2023,
    km: 15000,
    preco: 47900,
    combustivel: "Diesel",
    ...
    consumo: "5,0 l/100km",
    descricao:
      "Mercedes-Benz Classe C 220d com o pack AMG Line, elegante e desportiva. Excelente relação entre conforto, tecnologia e consumo.",
    destaques: [
      "Pack exterior e interior AMG Line",
      "MBUX com ecrã de grandes dimensões",
